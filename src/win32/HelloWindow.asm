...
;-------------------------------------------------------------------------------------------------------------------
;compile: ml /coff link /subsystem:windows /entry:MainEntry; if this entry is not defined , it'll keep asking for _WinMainCRTStartup
...
include C:\masm32\include\windows.inc		; Main windows header file (akin to Windows.h in C)
...
includelib C:\masm32\lib\kernel32.lib		; Kernel32.dll
includelib C:\masm32\lib\user32.lib		; User32.dll
includelib C:\masm32\lib\gdi32.lib		; GDI32.dll

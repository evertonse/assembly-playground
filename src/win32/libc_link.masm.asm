...
; libc_link.masm.asm
;
; Displays libc_link.masm of 2 from 2^0 to 2^31, one per line, to standard output.
;
; Processor: 386 or later
; Assembler: MASM
; OS: Any Win32-based OS
; Other libraries: Use a Microsoft-compatible C library (e.g. libc.lib).
; Assemble: "ml libc_link.masm.asm /c"
; Link: "link libc_link.masm.obj libc.lib"
;
...
; initialization, calls a function "_main" (which will end up in libc_link.masm.obj)
